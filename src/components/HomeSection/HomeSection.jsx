  ...
  return (
    ...
    >
      <div className="container flex flex-col justify-center items-center h-full">
        <img
          className="max-w-full md:w-[40rem] mb-8 md:mb-10"
          src={logo}
          alt="logo"
        />
        <h2 className="mb-12 font-mario text-m-blue drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.9)] tracking-widest md:text-2xl md:mb-14">
          {" "}
          I&apos;m a full-stack web developer
          <br /> with a love for all things tech
        </h2>
        <p className="max-w-xl text-justify hyphens-auto p-4 rounded-xl bg-white/5 shadow-lg ring-1 ring-black/5 backdrop-blur-md md:text-xl">
